...
const AssignmentEditor: React.FC<IEditor> = ({ mode }) => {
  ...
  const {
    data: calibrationSubmissionsResponse,
    error: calibrationSubmissionsError,
    sendRequest: sendCalibrationSubmissionsRequest,
  } = useAPI();
 ...
 */
  const getInitialValues = (): IAssignmentFormValues => {
    ...
    (Object.keys(initialValues) as (keyof IAssignmentFormValues)[]).forEach((key) => {
...
>>>>>>> 474e9f770b1b333949189375253f18e38e3d7284
  ...
  const onSubmit = (
    ...
    if (hasWeights && totalWeight !== 100) {
      dispatch(
        alertActions.showAlert({ variant: "danger", message: "Sum of weights must be 100%" })
      );
      return;
    }
  ...
  const teammateReviewOptions = (assignmentData.questionnaires || [])
    .filter((q: any) => {
      const questionnaireType = String(q.questionnaire_type || "");
      const questionnaireName = String(q.name || "");
      return (
          ...
          return (
            <Form>
              <Tabs defaultActiveKey="general" id="assignment-tabs">
                ...
                <Tab eventKey="general" title="General">
                  <div style={{ width: "40%", marginTop: "20px" }}>
                    ...
                    >
                      ...
                      <div style={{ display: "flex", columnGap: "5px" }}>
                        ...
                        <ToolTip
                          id={`assignment-directory_path-tooltip`}
                          info="Mandatory field. No space or special chars. Directory name will be autogenerated if not provided, in the form of assignment_[assignment_id]."
                        />
                      </div>
                  ...
                  {formik.values.has_topics && (
                    <div style={{ paddingLeft: 30 }}>
                      <FormCheckbox
                        controlId="assignment-staggered_deadline_assignment"
                        label="Staggered deadline assignment?"
                        name="staggered_deadline_assignment"
                      />
                    </div>
                  )}
                ...
                {formik.values.is_role_based && (
                  ...
                  <FormCheckbox
                    controlId="assignment-has_quizzes"
                    label="Has quizzes?"
                    name="has_quizzes"
                  />
                  <FormCheckbox
                  ...
                  <div style={{ marginTop: "20px" }}>
                    <Table
                      ...
                      data={[
                        ...
                        })(),
                        {
                          ...
                          questionnaire_options: [
                            {
                              label: "Standard author feedback",
                              value: "Standard author feedback",
                            },
                          ],
                          questionnaire_type: "dropdown",
                        },
                      ...
                      columns={[
                        {
                          cell: ({ row }) => (
                            <div style={{ marginRight: "10px" }}>{row.original.title}</div>
                          ),
                          accessorKey: "title",
                          header: "",
                          enableSorting: false,
                            ...
                            <div style={{ marginRight: "10px" }}>
                              ...
                              {row.original.questionnaire_type === "tag_prompts" && (
                                <div style={{ marginBottom: "10px" }}>
                                  <Button variant="outline-secondary">+Tag prompt+</Button>
                                  <Button variant="outline-secondary">-Tag prompt-</Button>
                                </div>
                              )}
                            </div>
                        ...
                        },
                        {
                          cell: ({ row }) => {
                            ...
                            return (
                              <div style={{ marginRight: "10px" }}>
                                <div
                                  style={{ width: "70px", display: "flex", alignItems: "center" }}
                                >
                                  <FormInput
                            ...
                            <>
                              {row.original.questionnaire_type === "dropdown" && (
                                <>
                                  ...
                                  >
                                    <FormInput
                                      controlId={`assignment-notification_limit_${row.original.id}`}
                                      name={`notification_limits[${row.original.id}]`}
                                      type="number"
                                    />
                                    %
                                  </div>
                ...
                <Tab eventKey="due_dates" title="Due dates">
                        ...
                        columns={[
                          ...
                          },
                          {
                            cell: ({ row }) => (
                              <>
                                <FormCheckbox
                                  controlId={`assignment-use_date_updater_${row.original.id}`}
                                  name={`use_date_updater[${row.original.id}]`}
                                />
                              </>
                            ),
                            accessorKey: `use_date_updater`,
                            header: "Use date updater?",
                            enableSorting: false,
                            enableColumnFilter: false,
                          },
                          {
                            cell: ({ row }) => (
                              <>
                                <FormSelect
                                  controlId={`assignment-submission_allowed_${row.original.id}`}
                          ...
                          },
                          {
                            cell: ({ row }) => (
                              <>
                                <FormSelect
                                  controlId={`assignment-review_allowed_${row.original.id}`}
                          ...
                          },
                          {
                            cell: ({ row }) => (
                              <>
                                <FormSelect
                                  controlId={`assignment-teammate_allowed_${row.original.id}`}
                          ...
                          },
                          {
                            cell: ({ row }) => (
                              <>
                                <FormSelect
                                  controlId={`assignment-metareview_allowed_${row.original.id}`}
                                  name={`metareview_allowed[${row.original.id}]`}
                                  options={[
                                    { label: "Yes", value: "yes" },
                                    { label: "No", value: "no" },
                                  ]}
                            ...
                            accessorKey: "metareview_allowed",
                            header: "Meta-review allowed?",
                            enableSorting: false,
                            enableColumnFilter: false,
                          },
                          {
                            cell: ({ row }) => (
                              <>
                                <FormSelect
                                  controlId={`assignment-reminder_${row.original.id}`}
                                  name={`reminder[${row.original.id}]`}
                                  options={[
                                    { label: "1", value: "1" },
                                    { label: "2", value: "2" },
                                    { label: "3", value: "3" },
                  ...
                  <div style={{ display: "flex", alignItems: "center", columnGap: "10px" }}>
                    ...
                    <div style={{ marginBottom: "-0.3rem" }}>
                      <FormSelect
                        controlId={`assignment-late_policy_date_time`}
                        name={`late_policy_date_time`}
                              ...
                              if (row.original.review_status === "not_started") {
                                return (
                                  <a
                                    ...
                                    href={`/assignments/edit/${assignmentData.id}/calibration/${row.original.id}`}
                                  >
                                    Begin
                                  </a>
                                );
                          ...
                          },
                          {
                            cell: ({ row }) => (
                              <>
                                ...
                                >
                                  {row.original.submitted_content.hyperlinks.map(
                                ...
                                <div
                                  style={{ display: "flex", flexDirection: "column", gap: "5px" }}
                                >
                                  {row.original.submitted_content.files.map(
                                    (item: any, index: number) => {
                                      return (
                                        <a
                                          style={{ color: "#986633", textDecoration: "none" }}
                            ...
                            accessorKey: "submitted_content",
                            header: "Submitted items(s)",
                            enableSorting: false,
                            enableColumnFilter: false,
                          },
                        ]}
                ...
                <Tab eventKey="etc" title="Etc.">
                  <div className="assignment-actions d-flex flex-wrap justify-content-start">
                    ...
                    <div
                      ...
                      onClick={() => navigate(`/assignments/edit/${assignmentData.id}/createteams`)}
                    >
                      <img
                    ...
                    <div
                      className="custom-tab-button"
                      onClick={() =>
                        navigate(`/assignments/edit/${assignmentData.id}/viewsubmissions`)
                      }
                    >
                      <img
                    ...
                    <div
                      className="custom-tab-button"
                      onClick={() => navigate(`/assignments/edit/${assignmentData.id}/viewscores`)}
                    >
                      <img
                    ...
                    <div
                      className="custom-tab-button"
                      onClick={() => navigate(`/assignments/edit/${assignmentData.id}/viewreports`)}
                    >
                      <img
                    ...
                    <div
                      className="custom-tab-button"
                      onClick={() =>
                        navigate(`/assignments/edit/${assignmentData.id}/viewdelayedjobs`)
                      }
                    >
                      <img
              ...
              >
                ...
                |
                <a href="/assignments" style={{ color: "#a4a366", textDecoration: "none" }}>
                  Back
                </a>
              </div>
              {showDutyEditor && (
  ...
  return (
    <Modal size="lg" centered show={true} onHide={handleClose} backdrop="static">
      <Modal.Header closeButton>
        <Modal.Title>
          {mode === "update" ? `Update Assignment - ${assignmentData.name}` : "Create Assignment"}
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
              ...
              {(formik) => {
                return (
                  <Form>
                    ...
                    />
                    <FormInput
                      controlId="assignment-submitter_count"
                      label="Submitter Count"
                      name="submitter_count"
                      type="number"
                    />
                    <FormInput
                      controlId="assignment-num_reviews"
                      label="Number of Reviews"
                      name="num_reviews"
                      type="number"
                    />
                    <FormInput
                      controlId="assignment-num_review_of_reviews"
                      label="Number of Review of Reviews"
                      name="num_review_of_reviews"
                      type="number"
                    />
                    <FormInput
                      controlId="assignment-num_review_of_reviewers"
                      label="Number of Review of Reviewers"
                      name="num_review_of_reviewers"
                      type="number"
                    />
                    <FormInput
                      controlId="assignment-num_reviewers"
                    ...
                    />
                    <FormInput
                      controlId="assignment-days_between_submissions"
                      label="Days Between Submissions"
                      name="days_between_submissions"
                      type="number"
                    />
                    <FormInput
                      controlId="assignment-review_assignment_strategy"
                      label="Review Assignment Strategy"
                      name="review_assignment_strategy"
                    />
                    <FormInput
                      controlId="assignment-max_reviews_per_submission"
                    ...
                    <FormInput
                      controlId="assignment-review_topic_threshold"
                      label="Review Topic Threshold"
                      name="review_topic_threshold"
                      type="number"
                    />
                    <FormInput
                      controlId="assignment-rounds_of_reviews"
                      label="Rounds of Reviews"
                      name="rounds_of_reviews"
                      type="number"
                    />
                    <FormInput
                      controlId="assignment-num_quiz_questions"
                    ...
                    <FormInput
                      ...
                      label="Late Policy ID"
                      name="late_policy_id"
                      type="number"
                    />
                    <FormInput
                      controlId="assignment-max_bids"
                      label="Max Bids"
                      name="max_bids"
                      type="number"
                    />
                    ...
                    />
                    <FormCheckbox
                      controlId="assignment-has_badge"
                      label="Has badge?"
                      name="has_badge"
                    />
                    <FormCheckbox
                    ...
                    />
                    <FormCheckbox
                      controlId="assignment-reviews_visible_to_all"
                      label="Reviews Visible to All"
                      name="reviews_visible_to_all"
                    />
                    <FormCheckbox
                      controlId="assignment-allow_suggestions"
                      label="Allow Suggestions"
                      name="allow_suggestions"
                    />
                    <FormCheckbox
                      controlId="assignment-copy_flag"
                      label="Copy Flag"
                      name="copy_flag"
                    />
                    <FormCheckbox
                      controlId="assignment-microtask"
                      label="Microtask"
                      name="microtask"
                    />
                    <FormCheckbox
                      controlId="assignment-is_coding_assignment"
                      label="Is Coding Assignment"
                      name="is_coding_assignment"
                    />
                    <FormCheckbox
                      controlId="assignment-is_intelligent"
                      label="Is Intelligent"
                      name="is_intelligent"
                    />
                    <FormCheckbox
                      controlId="assignment-calculate_penalty"
                      label="Calculate Penalty"
                      name="calculate_penalty"
                    />
                    <FormCheckbox
                      controlId="assignment-is_penalty_calculated"
                      label="Is Penalty Calculated"
                    ...
                    />
                    <FormCheckbox
                      controlId="assignment-use_bookmark"
                      label="Use Bookmark"
                      name="use_bookmark"
                    />
                    <FormCheckbox
                      controlId="assignment-can_review_same_topic"
                      label="Can Review Same Topic"
                      name="can_review_same_topic"
                    />
                    <FormCheckbox
                      controlId="assignment-can_choose_topic_to_review"
                      label="Can Choose Topic to Review"
